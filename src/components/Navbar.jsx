...
function Navbar() {
  return (
    <div className=" p-4 flex  items-center text-gray-600 font-semibold text-sm">
      <div className="flex pl-15 gap-15 mr-40">
        <p className="font-weight-400">Cost Calculator </p>
        <p className="font-weight-400">Discover Stores</p>
        <p className="font-weight-400">Track Orders</p>
      </div>
      <div className="mr-60">
        <p>Need help? Call: </p>
        <p className="text-blue-500 cursor-pointer">
          +2347069000083 or +2349035000505
        </p>
      </div>
      ...
      <div>
        <p className="border border-black-400 rounded-full p-1 px-3">Nigeria</p>
      </div>
    </div>
  );
}
